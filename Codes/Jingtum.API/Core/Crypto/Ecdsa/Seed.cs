...
namespace Jingtum.API.Core.Crypto.Ecdsa
{
    internal class Seed
    {
        ...
        public static IKeyPair GetKeyPair(String b58)
        {
            ...
            {
                throw new InvalidParameterException(JingtumMessage.INVALID_JINGTUM_SECRET, b58);
            }
        ...
        public static String GenerateSecret()
        {
            ...
            String seedString = Jingtum.SIGN_HASH_STRING + timestamp;
